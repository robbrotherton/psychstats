...
Running with the mechanical metaphore, it should be clear that if the mean was any other value, the scales would not be in balance; the deviations above and below the mean would not be equal and the scales would tip. In the visualation above, you can drag the triangle to see the effect of arbitrarly changing the value of the mean.
